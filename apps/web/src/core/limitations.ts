export const privacyTooltip = [
  ...
  "브라우저 메모리 보호를 위해 한 번에 지원 소스 5,000개, 파일당 2MB까지만 읽습니다.",
  "웹 Record는 함수당 한 개의 기본 노트를 저장하며, 여러 분석 문서·줄 참조·Markdown 미리보기·Confluence 복사는 데스크탑 앱에서만 지원됩니다.",
  "웹 Collections는 생성·함수 추가·순서·역할·메모 중심의 기본 기능을 제공합니다. 개요·태그·수동 재연결·검토 완료·Confluence 내보내기는 데스크탑 전용입니다.",
  "여러 저장소를 동시에 등록하거나 앱 안에서 자동 업데이트하는 기능은 데스크탑 앱에서만 지원됩니다.",
